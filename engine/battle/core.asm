...
.player_mon_did_not_faint
	...
	ld [wBattleResult], a ; WIN
	; fallthrough
ApplyExperienceAfterEnemyCaught: ; VIVI
; VIVI BEGIN: EXP SHARE
	...
	xor 1 ; VIVI: Invert the value so EXP Share is ON from the start
	and a
	ret z
...
; VIVI - Removed IsAnyMonHoldingExpShare since it's unused
...
PlayVictoryMusic:
	...
	; VIVI - removed check for EXP Share
	ld hl, wPayDayMoney
	ld a, [hli]
	or [hl]
	jr nz, .play_music
...
; Don't give experience if linked or in the Battle Tower.
	...
	; VIVI - We want 100% of total EXP to be given to every pokemon
	;        instead of dividing among exp sharers
...
; VIVI - removed unused divide EXP among participants function
